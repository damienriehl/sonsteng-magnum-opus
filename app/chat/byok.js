...
(function () {
  ...
  var CSS = [
    ...
    '  color:var(--claret);background:var(--paper);border:var(--rule) solid var(--line);',
    ...
    '.byok-note{font-style:italic;color:var(--ink-soft);background:var(--paper-3);',
    ...
    '.byok-warn{border:var(--rule-bold) solid var(--claret);background:var(--claret-wash);',
    ...
    '  background:var(--paper);border:var(--rule) solid var(--line);border-left:var(--rule-bold) solid var(--brass);',
    ...
    '  border:var(--rule) solid var(--claret);background:var(--claret);color:var(--ink-invert)}',
    '.byok-btn--ghost{background:transparent;color:var(--claret);border-color:var(--line)}',
