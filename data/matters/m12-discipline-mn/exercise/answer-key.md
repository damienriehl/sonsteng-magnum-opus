...
|---|---|---|---|---|
| Volunteered | the paralegal's file handoff | [m12.fact.013] | Offered early | The systems-failure framing she leads with. |
| Volunteered | efforts to reopen the case | [m12.fact.024] | Volunteered | The motion to vacate. |
| Volunteered | steps taken afterward | [m12.fact.038] | Volunteered | The remedial docketing system — key mitigation. |
| Revealed-if-asked | the affidavit's timeline statement | [m12.fact.025] | Direct Q about the affidavit / the November 26 date | She'll acknowledge the affidavit said Nov. 26 and now sees the dismissal came Oct. 2 — but note she does NOT yet volunteer the September email here. |
| Revealed-if-asked | her background and record | [m12.fact.001] | Direct Q about her history | 19 years discipline-free — mitigation. |
| Revealed-if-asked | how deadlines were tracked | [m12.fact.004] | Direct Q about office systems | Supervision-charge groundwork. |
| **Rapport-gated** | when she saw the warning | [m12.fact.018] | **min_turns 6**; requires `confidentiality_reassurance` + `nonjudgmental_response` | **THE pivotal fact.** She admits she read the September email at the time — destroying the "only found out in November" story and reframing the candor defense. Surfaces only after real confidentiality reassurance and a non-judgmental reaction. A student who reacts with shock or accusation shuts it down and never learns the truth their own defense depends on. |
| **Rapport-gated** | her personal circumstances then | [m12.fact.040] | **min_turns 5**; requires `wellbeing_question` + `acknowledged_emotion` | The dying father / exhaustion. She views it as an excuse and won't raise it unless gently invited. Essential mitigation — the student must earn it and then counsel her on how (and whether) to put it before the referee. |
...
|---|---|---|---|---|
| Volunteered | how deadlines were tracked | [m12.fact.004] | Offered early | First-hand corroboration of the single-point-of-failure calendaring. |
| Volunteered | the paralegal's file handoff | [m12.fact.013] | Volunteered | "That's where the Dieterle service date disappeared" — the systems-failure narrative. |
| Revealed-if-asked | staffing after the departure | [m12.fact.014] | Direct Q about coverage after Delacroix left | Both lawyers covered the docket for months. |
...
| Tier | Topic label | Fact | Eliciting question / trigger | Common-miss notes |
|---|---|---|---|---|
| Volunteered | what she was told | [m12.fact.021] | Offered early | She confirms the October "case is moving along" reassurance was false — corroborating the concealed client-lie fact from the other side. |
| Revealed-if-asked | the client's related legal action | [m12.fact.041] | Direct Q | She names Achterberg and says "you should be talking to her" — the persona itself surfaces the 4.2 flag. |
| Revealed-if-asked | the client's underlying injury | [m12.fact.006] | Direct Q about the fall | Wrist/elbow surgery — harm-to-client evidence. |
| Unknown | the underlying claim's future | [m12.fact.042] | She genuinely doesn't know | — |
