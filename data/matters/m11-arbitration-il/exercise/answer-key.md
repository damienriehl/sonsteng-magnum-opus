...
|---|---|---|---|---|
| Volunteered | how he reads the timing | [m11.fact.022] | Offered early; any open "what happened" | Students who let him narrate get the timing theory for free — reward listening. |
| Volunteered | his internal HR complaint | [m11.fact.010] | Volunteered | — |
| Volunteered | the termination decision | [m11.fact.016] | Volunteered | — |
| Revealed-if-asked | pressure to work after clock-out | [m11.fact.005] | Direct Q about the crew's hours / off-the-clock work | Easy to miss if student jumps straight to the firing and never works the wage angle. |
| Revealed-if-asked | his complaint to the state | [m11.fact.012] | Direct Q: did you report anywhere else / outside the company? | The hotline report is the strongest *protected activity* — a student who never asks about external reporting misses it. |
| Revealed-if-asked | the performance improvement plan | [m11.fact.013] | Direct Q about discipline/reviews | — |
| Revealed-if-asked | what he wants to recover | [m11.fact.031] | Direct Q about goals/objectives | Goals inquiry (interview phase 4) — non-monetary objectives (reference) are the counseling key. |
| **Rapport-gated** | his worries about future work | [m11.fact.035] | **min_turns 4**; requires a `wellbeing_question` + `acknowledged_emotion` | The blackballing fear is the client's true objective driver; unlocks only after a genuine open wellbeing question and an empathetic acknowledgment. Pressure/insistence never unlocks it. |
| **Rapport-gated** | his personal record-keeping | [m11.fact.033] | **min_turns 5**; requires `follow_up_on_hint` | The private notebook is powerful corroboration of crew-wide unpaid time [m11.fact.032]. He hints; the student must *follow the hint*, not steamroll past it. |
| **Rapport-gated** | a past timekeeping decision | [m11.fact.034] | **min_turns 6**; requires `confidentiality_reassurance` + `nonjudgmental_response` | The August timecard edit is his biggest fear (impeachment fodder). Surfaces only after confidentiality reassurance and a non-judgmental reaction. A student who reacts with alarm shuts it down — teach measured neutrality. |
...
|---|---|---|---|---|
| Volunteered | unpaid time after the shift | [m11.fact.023] | Offered early | Corroborates the off-the-clock pattern first-hand. |
| Revealed-if-asked | what the manager said | [m11.fact.024] | Direct Q: did you ever hear Pfeiffer say anything about the hours? | "Keep the belt running after the shift" is direct evidence tying Pfeiffer to the unpaid work — a key cross theme. |
...
| Tier | Topic label | Fact | Eliciting question / trigger | Common-miss notes |
|---|---|---|---|---|
| Volunteered | the company's stated rationale | [m11.fact.028] | Volunteered | The "it was only about accuracy" line — the pretext the student must break down. |
| Revealed-if-asked | the performance improvement plan | [m11.fact.013] | Direct Q | Confirms he authored the PIP. |
| Revealed-if-asked | the termination decision | [m11.fact.016] | Direct Q | Confirms both rationales — set up the internal contradiction on cross. |
| **Concealed** | who saw his complaint | [m11.fact.027] | Will NOT volunteer that HR forwarded the complaint on Nov. 12 | The knowledge fact. He conceals it; the student must prove it through the *documents* (the email chain), not by hoping he admits it. This is the whole ballgame — teach that the exhibit, not the witness, wins the point. |
| Unknown | the company's notice of the report | [m11.fact.029] | Deflects to HR | — |
