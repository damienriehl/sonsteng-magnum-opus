...
> Provenance: Authored on 2026-08-05, this plan lived only on an unmerged branch until 2026-08-17, when the plan-completion audit landed it so it would no longer be invisible. It is superseded by `docs/plans/2026-08-09-001-feat-taxonomy-publisher-batches-plan.md`, with the promotion-summary work parked, and is retained as history rather than live work.
